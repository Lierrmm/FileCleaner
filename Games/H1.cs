namespace FileCleaner.Games
{
    ...
    {
        public override string WELCOME_MESSAGE => "COD: Modern Warfare Remastered Cleaner";
        public override string[] GAME_EXECUTABLES { get; } = { "h1_mp64_ship.exe", "h1_sp64_ship.exe" };
